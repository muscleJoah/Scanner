...
public class Token {
    ...
    public static final Token startcomment = new Token(TokenType.StartComment, "StartComment");
    public static final Token endcomment = new Token(TokenType.EndComment, "EndComment");
    ...
    public String toString (String str ) {
        ...
        return type+" (Token number : "+type.ordinal()+ "\tToken value : "+value+"\tfilename : "+str +"   ";
